...
namespace TsAnalyser
{
    ...
    {
        public delegate void DiscontinuityDetectedEventHandler(object sender, DiscontinutityEventArgs args);
        ...
        protected virtual void OnDiscontinuityDetected(int tsPid)
        {
            ...
            var args = new DiscontinutityEventArgs {TsPid = tsPid};
            handler(this, args);
        }
    }

    public class DiscontinutityEventArgs : EventArgs
    {
