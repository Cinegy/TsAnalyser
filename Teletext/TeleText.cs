    ...
    public class TeleText
    {
        ...
        private void DecodeTeletextDataInternal(IList<byte> data)
        {
            ...
            if (0 == y)
            {
                ...
                //TODO: Check making things static here did not bust something
                Utils.PrimaryCharset.G0X28 = Utils.Undef;

                var c = (Utils.PrimaryCharset.G0M29 != Utils.Undef) ? Utils.PrimaryCharset.G0M29 : charset;
                Utils.remap_g0_charset(c);
            ...
            else if ((m == Utils.Magazine(PageNumber)) && (y == 28) && (_receivingData))
            {
                ...
                else
                {
                    ...
                    {
                        //TODO: Check move to static did not bust something here
                        Utils.PrimaryCharset.G0X28 = (byte)((triplet0 & 0x3f80) >> 7);
                        Utils.remap_g0_charset(Utils.PrimaryCharset.G0X28);
                    }
                }
            }
            else if ((m == Utils.Magazine(PageNumber)) && (y == 29))
            {
                ...
                if ((designationCode == 0) || (designationCode == 4))
                {
                    ...
                    else
                    {
                        ...
                        //TODO: Check move to static did not break this / refactor
                        Utils.PrimaryCharset.G0M29 = (byte)((triplet0 & 0x3f80) >> 7);
                        // X/28 takes precedence over M/29
                        if (Utils.PrimaryCharset.G0X28 == Utils.Undef)
                        {
                            Utils.remap_g0_charset(Utils.PrimaryCharset.G0M29);
                        }
                    }
                }
            }
